...
class GesturePublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(HeadTouchGesture, 'head_touch_gesture', 10)
    ...
    def timer_callback(self):
        ...
        self.get_logger().info('Publishing: gesture=%d, value=%d, direction=%d' % (msg.gesture, msg.value, msg.direction))
